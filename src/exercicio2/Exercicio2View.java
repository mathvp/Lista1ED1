...
public class Exercicio2View extends JFrame {
	...
	private JTextField[] campos = new JTextField[Exercicio2Model.TAM_VETOR];
	 ...
	 * Create the frame.
	 */
	public Exercicio2View(Exercicio2Model model) {
		...
		panel_2.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "Exercicio 2", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
		...
		JLabel lblEscrevaUm = new JLabel("<html><b>2.</b> Escreva um programa que leia 10 n\u00FAmeros inteiros e os armazene em um vetor. Em seguida, imprima o vetor, o maior elemento, o menor elemento e a posi\u00E7\u00E3o dos respectivos elementos no vetor.</html>");
	...
	void validaDados() {
		int erros = 0;
		for(int i=0; i<Exercicio2Model.TAM_VETOR; i++) {
			try {
	...
	public int[] getAllInputsVal() {
		int[] valores = new int[Exercicio2Model.TAM_VETOR];
