...
public class Resultado extends JDialog implements ActionListener{
	...
	public Resultado() {
		...
		panel.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "Ex. 5 - Resultado", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
		...
		gl_panel.setVerticalGroup(
			gl_panel.createParallelGroup(Alignment.TRAILING)
				.addGroup(Alignment.LEADING, gl_panel.createSequentialGroup()
					.addContainerGap()
					.addComponent(scrollPaneTb, GroupLayout.DEFAULT_SIZE, 221, Short.MAX_VALUE)
					.addContainerGap())
		);
